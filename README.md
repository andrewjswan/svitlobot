...
## Прошивка
Встановити прошивку можна за допомогою [ESPHome](https://esphome.io/) скориставшись одним із готових файлів конфігурацій, або використовувати [**SvitloBot - ESP Web Tools**](https://andrewjswan.github.io/svitlobot/) - зручний інструмент для встановлення та оновлення прошивки пристроїв ESP8266 та ESP32 у браузері.
<br/><br/>
> [!NOTE]
