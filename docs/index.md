...
1.  **Web Installer (Рекомендовано):** Скористайтеся [**SvitloBot - ESP Web Tools**](firmware.html). Це найпростіший шлях — просто підключіть `ESP` до `USB` та натисніть `Connect` у браузері.
